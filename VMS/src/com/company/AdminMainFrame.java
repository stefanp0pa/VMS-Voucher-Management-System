...
public class AdminMainFrame extends JFrame implements ActionListener {
    ...
    private JPanel optionsAboutPanel;
    ...
    private void addComponentsToPanels() {
        ...
        optionsAboutPanel.add(aboutAppButton);
    ...
    private void initializeButtons(){
        ...
        aboutAppButton = new JButton("Despre aplicatie");
        ...
        aboutAppButton.setFocusPainted(false);
        ...
        aboutAppButton.setBackground(buttonBackgroundColor);
        ...
        aboutAppButton.setPreferredSize(new Dimension(300,40));
        aboutAppButton.setFont(new Font("Dialog",Font.PLAIN,20));
    ...
    private void initializePanels(){
        ...
        optionsAboutPanel.setBackground(panelBackgroundColor);
        ...
        mainPanel.add(optionsAboutPanel);
